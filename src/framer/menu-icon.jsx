...
// /:https://framerusercontent.com/modules/jzpWrwcMydRaudb2EFpg/JFlT26A6ofEqdNbcHgGW/rYRqmI1eP.js
...
var getProps = ({ height, id, radius, width, ...props }) => {
	return {
		...
		variant:
			humanReadableVariantMap[props.variant] ?? props.variant ?? "fdpGvkEzL",
	};
};
