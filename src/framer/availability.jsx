...
// /:https://framerusercontent.com/modules/zUbaNIH6HrklYjWhWUv6/8uF4BNM3e0Fc5xMsFREO/i4bgRBcDo.js
...
var getProps = ({ greenText, height, id, redText, width, ...props }) => {
	return {
		...
		variant:
			humanReadableVariantMap[props.variant] ?? props.variant ?? "OIMsOnQae",
	};
};
